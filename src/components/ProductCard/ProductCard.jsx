  ...
  return (
    ...
    >
      <div className={styles.cardTop}>
        <div className={styles.thumb}>
          {product.image_url ? (
            ...
            <div className={styles.thumbPlaceholder}>Image</div>
          )}
        </div>

        {/* Если нужно добавить логику избранного */}
        <button
      ...
      <div className={styles.rowTop}>
        <h3 id={`p-${product.id}-title`} className={styles.title}>
          {product.name}
        </h3>
        <div className={styles.meta}>
          {product.category} · ≈ {product.time} min
        </div>
      </div>
